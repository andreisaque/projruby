...
class ProjetosControllerTest < ActionController::TestCase
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post :create, projeto: { endereco: @projeto.endereco, matricula: @projeto.matricula, nome: @projeto.nome, telefone: @projeto.telefone }
    end
  ...
  test "should update projeto" do
    patch :update, id: @projeto, projeto: { endereco: @projeto.endereco, matricula: @projeto.matricula, nome: @projeto.nome, telefone: @projeto.telefone }
    assert_redirected_to projeto_path(assigns(:projeto))
  end
